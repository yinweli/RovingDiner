...
// playHint 出牌模式鍵位列行 2 提示(【營業顯示規格書 | 6、畫面規格 | 6.11】): 玩家行動等待中的固定
// 提醒文字; 顯示端自持(引擎不下傳, 與選取提示前文的來源相反)。
const playHint = "輪到玩家行動: 請出牌, 或結束出牌"
...
// hint 非空時取代行 2(選取模式的選取提示 / 出牌模式的出牌提示; 【營業顯示規格書 | 6、畫面規格 | 6.11】
// 行 1 鍵位、行 2 提示)。
