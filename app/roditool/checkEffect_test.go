...
func (this *SuiteCheckEffect) TestCheckEffect() {
	...
	sheet.Effect.Data = map[int32]*sheeter.Effect{
		...
		402: {ID: 402, Kind: 1, TargetKind: 7},                         // TargetKind 超界
		403: {ID: 403, Kind: 1, TriggerAfter: 2},                       // TriggerAfter 超界
		404: {ID: 404, Kind: 1, StackTime: 5},                          // StackTime 超界
		405: {ID: 405, Kind: 1, TriggerKind: "nope"},                   // 未知觸發時機名稱
		406: {ID: 406, Kind: 1, TriggerCond: "morale >"},               // 運算式文法錯
		407: {ID: 407, Kind: 1, CommandTrigger: "noSuchCommand(none)"}, // 命令詞彙錯(引擎編譯只 Parse 不攔)
...
func (this *SuiteCheckEffect) TestCheckEffectMatrix() {
	...
	sheet.Effect.Data = map[int32]*sheeter.Effect{
		...
		402: {ID: 402, Kind: 1, CommandImmed: "morale += 1", CommandStart: "morale += 1"},   // 觸發: 立即 / 啟動命令不適用
