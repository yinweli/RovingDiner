...
| Path         | Contents                                                                                                                                                                                                                                                                                                                                                                |
|:-------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `gamedata/`  | Source xlsx tables and the Sheeter build config (`sheeter.yaml`); the build script `build.bat` sits at the repo root (shipped to the zip root for planners)                                                                                                                                                                                                             |
