...
func writeRefCost(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefExtraRunMin(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefExtraRunMax(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefCardSeal(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefKeep(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefPlayExile(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefUnplayExile(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	card, ok := AsCard(ref)
...
func writeRefCalm(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
...
func writeRefSate(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefSateMax(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefMorale(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefMoraleMax(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefScore(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefScoreMax(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefSateSeal(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
...
func writeRefCalmSeal(game *Game, ref exprs.Ref, op AssignKind, n float64) bool {
	guest, ok := AsGuest(ref)
